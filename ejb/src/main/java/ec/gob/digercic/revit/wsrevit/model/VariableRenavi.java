...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "VariableRenavi.findAll", query = "SELECT v FROM VariableRenavi v"),
...
public class VariableRenavi implements Serializable {
	...
	public String toString() {
		//return varNombre;
		return "ec.gob.digercic.revit.wsrevit.model.VariableRenavi[ id=" + varId + " ]";
	}
