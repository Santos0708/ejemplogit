...
/**
 * <p>Clase Java para getUsuariosByAgencia complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuariosByAgencia"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuariosByAgencia", propOrder = {
    "idAgencia"
})
public class GetUsuariosByAgencia {
