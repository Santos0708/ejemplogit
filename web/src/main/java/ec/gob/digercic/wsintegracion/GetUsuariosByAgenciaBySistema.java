...
/**
 * <p>Clase Java para getUsuariosByAgenciaBySistema complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuariosByAgenciaBySistema"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuariosByAgenciaBySistema", propOrder = {
    "idAgencia",
    "idSistema"
})
public class GetUsuariosByAgenciaBySistema {
