...
/**
 * <p>Clase Java para getSegAccesoByIdsRol complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getSegAccesoByIdsRol"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getSegAccesoByIdsRol", propOrder = {
    "idRol",
    "status"
})
public class GetSegAccesoByIdsRol {
