...
/**
 * <p>Clase Java para getUsuAgenciaByUserAndAgencia complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuAgenciaByUserAndAgencia"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuAgenciaByUserAndAgencia", propOrder = {
    "nomUsuario",
    "idAgencia"
})
public class GetUsuAgenciaByUserAndAgencia {
