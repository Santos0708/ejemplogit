...
/**
 * <p>Clase Java para getUsuarioByUserAndAgenciaResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuarioByUserAndAgenciaResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuarioByUserAndAgenciaResponse", propOrder = {
    "tblSauregUsuario"
})
public class GetUsuarioByUserAndAgenciaResponse {
