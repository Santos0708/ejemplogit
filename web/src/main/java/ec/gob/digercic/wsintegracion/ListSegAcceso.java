...
/**
 * <p>Clase Java para listSegAcceso complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listSegAcceso"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="segAccesoList" type="{http://service.registrocivil.gob.ec/}tblSauregSegAcceso" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "listSegAcceso", propOrder = {
    "codError",
    "desError",
    "estError",
    "segAccesoList"
})
public class ListSegAcceso {

    protected String codError;
    protected String desError;
    protected String estError;
    @XmlElement(nillable = true)
    protected List<TblSauregSegAcceso> segAccesoList;
    ...
    /**
     * Gets the value of the segAccesoList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the segAccesoList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSegAccesoList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TblSauregSegAcceso }
     * 
     * 
     */
    public List<TblSauregSegAcceso> getSegAccesoList() {
        if (segAccesoList == null) {
            segAccesoList = new ArrayList<TblSauregSegAcceso>();
        }
        return this.segAccesoList;
    }
