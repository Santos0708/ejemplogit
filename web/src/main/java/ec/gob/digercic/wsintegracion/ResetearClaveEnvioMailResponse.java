...
/**
 * <p>Clase Java para resetearClaveEnvioMailResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="resetearClaveEnvioMailResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "resetearClaveEnvioMailResponse", propOrder = {
    "tblSauregUsuario"
})
public class ResetearClaveEnvioMailResponse {
