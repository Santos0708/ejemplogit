...
/**
 * <p>Clase Java para tblSauregUsuAgenciaPK complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="tblSauregUsuAgenciaPK"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "tblSauregUsuAgenciaPK", propOrder = {
    "idAgencia",
    "nomUsuario"
})
public class TblSauregUsuAgenciaPK {
