...
/**
 * <p>Clase Java para listAgencia complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listAgencia"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="listAgencia" type="{http://service.registrocivil.gob.ec/}tblSauregAgencia" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "listAgencia", propOrder = {
    "codError",
    "desError",
    "estError",
    "listAgencia"
...
public class ListAgencia {
    ...
    protected List<TblSauregAgencia> listAgencia;
    ...
    /**
     * Gets the value of the listAgencia property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the listAgencia property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getListAgencia().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TblSauregAgencia> getListAgencia() {
        if (listAgencia == null) {
            listAgencia = new ArrayList<TblSauregAgencia>();
        }
        return this.listAgencia;
    }
