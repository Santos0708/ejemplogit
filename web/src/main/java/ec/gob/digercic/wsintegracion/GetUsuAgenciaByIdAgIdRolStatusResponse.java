...
/**
 * <p>Clase Java para getUsuAgenciaByIdAgIdRolStatusResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuAgenciaByIdAgIdRolStatusResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuAgenciaByIdAgIdRolStatusResponse", propOrder = {
    "listUsuAgencia"
})
public class GetUsuAgenciaByIdAgIdRolStatusResponse {
