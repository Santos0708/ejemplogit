...
/**
 * <p>Clase Java para getUsuarioByUserAndAgenciaMsp complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuarioByUserAndAgenciaMsp"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuarioByUserAndAgenciaMsp", propOrder = {
    "nomUsuario",
    "codMsp"
})
public class GetUsuarioByUserAndAgenciaMsp {
