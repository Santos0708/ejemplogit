...
/**
 * <p>Clase Java para getUsuariosByIdAgenciaIdRol complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuariosByIdAgenciaIdRol"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuariosByIdAgenciaIdRol", propOrder = {
    "idAgencia",
    "idRol",
    "status"
})
public class GetUsuariosByIdAgenciaIdRol {
