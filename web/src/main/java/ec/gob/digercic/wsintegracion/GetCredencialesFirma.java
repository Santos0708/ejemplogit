...
/**
 * <p>Clase Java para getCredencialesFirma complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getCredencialesFirma"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getCredencialesFirma", propOrder = {
    "nomUsuario"
})
public class GetCredencialesFirma {
