...
/**
 * <p>Clase Java para listUsuario complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listUsuario"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="listUsuario" type="{http://service.registrocivil.gob.ec/}tblSauregUsuario" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "listUsuario", propOrder = {
    "codError",
    "desError",
    "estError",
    "listUsuario"
...
public class ListUsuario {
    ...
    protected List<TblSauregUsuario> listUsuario;
    ...
    /**
     * Gets the value of the listUsuario property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the listUsuario property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getListUsuario().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TblSauregUsuario> getListUsuario() {
        if (listUsuario == null) {
            listUsuario = new ArrayList<TblSauregUsuario>();
        }
